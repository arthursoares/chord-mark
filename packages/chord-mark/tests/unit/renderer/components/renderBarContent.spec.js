...
describe('spaces after & spaces within', () => {
	describe.each([
...
describe('shouldPrintChordsDuration', () => {
	describe.each([
		[
...
describe('shouldPrintBarSeparators', () => {
	describe.each([
...
describe('shouldPrintSubBeatDelimiters', () => {
	describe.each([
		...
		[
			'1 group, 8thT notes, 2nd beat',
			'F. [C A7 G] Em..',
			'F  [C A7 G]  Emi  ',
		],
		[
			'1 group, 8thT notes, 3rd beat',
			'F.. [C A7 G] Em.',
			'F  [C A7 G]  Emi  ',
		],
		...
		'%s: %s',
		(title, input, output, shouldPrintSubBeatDelimiters = true) => {
...
describe('shouldPrintTimeSignature', () => {
	describe.each([
...
describe('symbolType', () => {
	describe.each([
		['render chord symbols (default)', 'C.. F. G.', 'C  F  G  '],
		['render chord symbols', 'C.. F. G.', 'C  F  G  ', 'chord'],
		['render roman numeral symbols', 'C.. F. G.', 'I  IV  V  ', 'roman'],
